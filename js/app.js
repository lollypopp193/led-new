...
window.currentColor = {
    ...
    g: 0,
    b: 0
}; // Aktuelle LED-Farbe (global für alle Seiten)
...
window.AppBLE = {
    get active() {
        return AppState.ble.active;
    },
    set active(value) {
        AppState.ble.active = value;
    },
    get controller() {
        return AppState.ble.controller;
    },
    set controller(value) {
        AppState.ble.controller = value;
    }
};
...
function loadApp(app) {
    ...
    // App-Dateien Mapping
    const appFiles = {
        'farbe': 'pages/Farbe.html',
        'effekt': 'pages/Effekt.html',
        'musik': 'pages/musik.html',
